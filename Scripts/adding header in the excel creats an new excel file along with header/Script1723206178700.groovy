...
if (excelFile.exists() && excelFile.length() > 0) {
    ...
    headerCell1.setCellValue("Username") // Set your desired header names here

    // Add more headers if necessary
    // Cell headerCell2 = headerRow.createCell(1)
    // headerCell2.setCellValue("Another Header")
}
...
println("Global variable value saved to Excel successfully with headers!")
